...
func runAPI(cfg config.Config) error {
	...
	v2.Post("/hitlists/:id/votes", requireAuth, hitlistH.Vote)
	v2.Delete("/hitlists/:id/votes", requireAuth, hitlistH.Unvote)
	v2.Get("/hitlists/:id/comments", optionalAuth, hitlistH.ListComments)
	v2.Post("/hitlists/:id/comments", requireAuth, hitlistH.AddComment)
	v2.Delete("/hitlists/:id/comments/:commentId", requireAuth, hitlistH.DeleteComment)
